...
; Version 1.3 - Change to AM/PM to 24h transformation: only add 12h when time is PM and the hour is not 12, since 12:10 PM equals 12:10 (24h)
...
Func GetEventTimestamp($sDate, $sTime)
   ...
   If ($aTime[4] = "PM") And (Not ($aTime[1] = 12)) Then
	  $aTime[1] = $aTime[1] + 12
   EndIf
